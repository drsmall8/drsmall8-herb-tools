...
function calculateResult() {
    ...
    const isG6pdChecked = document.getElementById('g6pdToggle') ? document.getElementById('g6pdToggle').checked : false;
    const isDopingChecked = document.getElementById('dopingToggle') ? document.getElementById('dopingToggle').checked : false;
...
function runEducationalAnalysis() {
    ...
    const currentMode = document.getElementById('analysisModeSelect').value;
    ...
    let activeTabId = document.querySelector('.tab-btn.active').id;
